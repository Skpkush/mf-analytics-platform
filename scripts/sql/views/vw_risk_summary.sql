-- ============================================================
-- vw_risk_summary  (v5 — fix asset_class via Dim_Category join)
--
-- Dialect: PostgreSQL (local is the primary post-Azure-trial DB).
--
-- asset_class fix (2026-06-05): same root cause as vw_fund_performance —
-- dim_fund.category_key was NULL for all ETFs/benchmarks. Fixed at source
-- in scripts/etl/load_dimensions.py + backfilled via
-- scripts/sql/fix_asset_class_local.py. asset_class now resolves to the
-- dashboard labels Index / Equity / Gold / Liquid / Debt / Hybrid.
-- ============================================================
